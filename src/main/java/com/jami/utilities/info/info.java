...
public class info {
  ...
  public void bot() {
    EmbedBuilder embed = new EmbedBuilder()
        ...
        .setFooter("Made with ❤️ by JamiTheFox", event.getJDA().getUserById(190855924368277508L).getAvatarUrl());
  ...
  public void guild() {
    ...
    EmbedBuilder embed = new EmbedBuilder()
        ...
        .addField("Channels (exc. Categories)", String.valueOf(g.getChannels().size() - g.getCategories().size()), true)
        .addField("", "", true)
  ...
  public void member(Member m) {
    ...
    EmbedBuilder embed = new EmbedBuilder()
        ...
        .addField("User Since", m.getTimeCreated().toString(), true)
        .addField("Member Since", m.getTimeJoined().toString(), true)
